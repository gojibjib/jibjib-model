...
def _get_examples_batch():
  ...
  #rootDir = "/Volumes/Backup/animal_voices/files"
  ...
  for dirName,subdirList, fileList in os.walk(rootDir):
    ...
    for fname in fileList:
        ...
        #takes out random sequence from entire spectrogram (for instance 3 frames = 3 seconds of audio)
